    ...
    <form class="yottie-demo-form">
        <div class="yottie-demo-accordion">
            <div class="yottie-demo-accordion-item-active yottie-demo-accordion-item">
                ...
                <div class="yottie-demo-accordion-item-content">
                    ...
                    <div class="yottie-demo-source-groups yottie-demo-field-group">
                        ...
                        <div class="yottie-demo-field-group-name"><?php _e('Source groups', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></div>

                        <div class="yottie-demo-field-group-description">
                            <?php _e('Create custom groups of videos from any YouTube source (channels, playlists, videos).', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?>
                        </div>
            ...
            <div class="yottie-demo-accordion-item">
                ...
                <div class="yottie-demo-accordion-item-content">
                    <div class="yottie-demo-lang yottie-demo-field">
                        <span class="yottie-demo-field-name-inline yottie-demo-field-name"><?php _e('Language', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
                    ...
                    <div class="yottie-demo-field-group">
                        <div class="yottie-demo-play-mode yottie-demo-field">
                            ...
                            <!--span class="yottie-demo-tooltip">
                                <span class="yottie-demo-tooltip-trigger">
                                    <span class="yottie-demo-tooltip-trigger-icon">?</span>

                                    <span class="yottie-demo-tooltip-content">
                                        <span class="yottie-demo-tooltip-content-inner">
                                            Video play mode description
                                        </span>
                                    </span>
                                </span>
                            </span-->
                    ...
                    <div class="yottie-demo-colors yottie-demo-field-group">
                        ...
                        <div class="yottie-demo-toggle">
                            <div class="yottie-demo-toggle-trigger">
                                ...
                                <div class="yottie-demo-colors-group-indicators"></div>
                            </div>
                        ...
                        <div class="yottie-demo-toggle">
                            <div class="yottie-demo-toggle-trigger">
                                ...
                                <div class="yottie-demo-colors-group-indicators">
                                    <!--span class="yottie-demo-colors-group-indicator" style="background-color:#fff;"></span>
                                    <span class="yottie-demo-colors-group-indicator" style="background-color:#fff;"></span-->
                                </div>
                            </div>
            ...
            <div class="yottie-demo-shortcode-container yottie-demo-accordion-item-detached yottie-demo-accordion-item">
                <div class="yottie-demo-accordion-item-trigger"><span class="yottie-demo-icon-shortcode yottie-demo-icon"></span><span><?php _e('Get Shortcode', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span></div>

                <div class="yottie-demo-accordion-item-content">
                    <p><?php _e('Copy this shortcode and paste it into any page or post.', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></p>
