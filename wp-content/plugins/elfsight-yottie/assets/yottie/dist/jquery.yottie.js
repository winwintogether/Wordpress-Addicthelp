...
"use strict";
var Olivie = require('./../../olivie/src/js/olivie'), $ = require('./../../olivie/src/js/jquery'), Yottie = require('./yottie'), defaults = require('./defaults'), schemes = require('./schemes');
var id = 0;
...
},{"./../../olivie/src/js/jquery":5,"./../../olivie/src/js/olivie":11,"./defaults":13,"./schemes":36,"./yottie":38}],16:[function(require,module,exports){
"use strict";
...
module.exports = Olivie.component('Popup', function () {
    ...
    getVideoCommentThreads: function () {
        ...
        var q = $.Deferred();
        self.youtube.model('youtube#commentThread').findAll({ videoId: self.video.id }, 'snippet').done(function (commentThreads) {
    ...
    createVideoElement: function () {
        var self = this, displaying = {}, parts = {}, date = 'Published on ' + new Date(Date.parse(self.video.snippet.publishedAt)).toLocaleDateString(), comments = [];
...
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Grid = require('./grid');
var $window = $(window);
module.exports = Olivie.class('FeedSection', [], function (controller, group) {
    ...
    self.fetcher = self.controller.youtube.createUniversalVideoFetcher(self.source, 'snippet,contentDetails,statistics');
    self.inlinePlayers = {};
            ...
            self.fetcher.prepare().done(function () {
                self.appendSlide().done(function () {
                    self.appendSlide(true).done(function () {
                        ...
                        setTimeout(function () {
                            if (self.swiper.autoplaying && !self.hover) {
    ...
    run: function () {
        ...
        var handleClick = function (e) {
            ...
            if (self.videoPlayMode === 'popup') {
                self.controller.popup.open('http://www.youtube.com/watch?v=' + id);
            } else {
    ...
    fitVideos: function ($videos) {
        ...
        $previews.find('.yottie-widget-video-preview-thumbnail').css({
            width: previewWidth,
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./grid":19}],18:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./feed-section":17}],19:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
module.exports = Olivie.class('Grid', [], function ($element, options) {
    ...
    calculate: function () {
        ...
        self.itemWidth = (elementWidth - guttersSummary) / self.columns;
    },
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11}],20:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
module.exports = Olivie.component('Groups', function () {
    ...
    run: function (sourceGroups) {
        var self = this;
        self.sourceGroups = $.extend(false, {}, sourceGroups);
        $.each(self.sourceGroups, function (i, item) {
            if (!item.name) {
                item.name = self.i18n.t('Untitled');
            }
        });
...
module.exports = Olivie.component('Header', function () {
    ...
    createHeaderElement: function () {
        ...
        displaying.banner = displaying.banner && self.channel.get('brandingSettings.image.bannerImageUrl');
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./model":27}],25:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./model":27}],26:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11}],27:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./model":27}],29:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./fetcher":26}],30:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./model":27}],31:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Fetcher = require('./fetcher');
module.exports = function (model) {
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./fetcher":26}],32:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
module.exports = Olivie.class('UniversalVideoFetcher', [], function (source, part, youtube) {
    ...
    hasNext: function () {
        var self = this;
        return self.fetchers.some(function (item) {
            return item.hasNext();
        });
    },
    prepare: function () {
        ...
        if (!self.isReady()) {
            ...
            $.each(self.fetchers, function (i, fetcher) {
                ...
                if (fetcher.constructor.id === 'VideoFetcher') {
                    fetchPromises.push(fetcher.fetchAll());
                } else {
            ...
            $.when.apply($, fetchPromises).done(function () {
                ...
                if (videoIds.length) {
                    self.youtube.model('youtube#video').findAll({ id: videoIds.join(',') }, self.part).done(function (list) {
                        Array.prototype.push.apply(self.stack, list);
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11}],33:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Fetcher = require('./fetcher');
module.exports = function (model) {
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./fetcher":26}],34:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./model":27}],35:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":5,"./../../../../olivie/src/js/olivie":11,"./channel":24,"./comment-thread":25,"./playlist":30,"./playlist-item":28,"./playlist-items-fetcher":29,"./playlists-fetcher":31,"./universal-video-fetcher":32,"./video":34,"./video-fetcher":33}],36:[function(require,module,exports){
"use strict";
module.exports = {
    default: {
        header: {
...
views['colorizer'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return ' #yottie_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' .yottie-widget-nav-inner::after { background: ' + alias3(alias4((stack1 = (stack1 = depth0 != null ? depth0.scheme : depth0) != null ? stack1.groups : stack1) != null ? stack1.highlight : stack1, depth0)) + '; } #yottie_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            'name': 'id',
            'hash': {},
            'data': data
...
views['feed']['container'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        return '<div class="yottie-widget-feed"><div class="yottie-widget-feed-inner"></div></div>';
    },
    'useData': true
});
...
views['groups']['container'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return '<div class="yottie-widget-nav' + ((stack1 = helpers.unless.call(depth0, depth0 != null ? depth0.visible : depth0, {
            ...
            'inverse': this.noop,
            'data': data
        })) != null ? stack1 : '') + '"><div class="yottie-widget-nav-inner"> ' + ((stack1 = (helper = (helper = helpers.list || (depth0 != null ? depth0.list : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'list',
            'hash': {},
            'data': data
...
views['popup']['video']['content'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return '<div class="yottie-popup-video-content"> ' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.displaying : depth0) != null ? stack1.info : stack1, {
            ...
            'inverse': this.noop,
            'data': data
        })) != null ? stack1 : '') + ' ' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.displaying : depth0) != null ? stack1.comments : stack1, {
            'name': 'if',
            'hash': {},
            'fn': this.program(3, data, 0),
            'inverse': this.noop,
...
views['video']['preview'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return ' <a href="https://www.youtube.com/watch?v=' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + '" target="_blank" class="yottie-widget-video-preview"><span class="yottie-widget-video-preview-thumbnail"><img src="' + alias3((helper = (helper = helpers.thumbnail || (depth0 != null ? depth0.thumbnail : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            'name': 'thumbnail',
            'hash': {},
            'data': data
        }) : helper)) + '" alt="' + alias3((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + '"/></span> ' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.displaying : depth0) != null ? stack1.duration : stack1, {
            'name': 'if',
            'hash': {},
            'fn': this.program(1, data, 0),
            'inverse': this.noop,
...
module.exports = Olivie.application('Yottie', function (id, element, options) {
    ...
    run: function () {
        ...
        if ($.type(self.options.sourceGroups) === 'string') {
            self.options.sourceGroups = $.parseJSON(decodeURIComponent(self.options.sourceGroups));
        }
        if ($.type(self.options.content.responsive) === 'string') {
        ...
        self.component('client').run().done(function () {
            self.component('header').run().on('ready', function (e, header) {
                ...
                if (self.options.sourceGroups) {
                    ...
                    sourceGroups = [{
                            name: self.component('i18n').t('Uploads'),
                            sources: [{
                                    kind: 'youtube#playlist',
